# Khadija Ali
**BS Artificial Intelligence Student** | **Data Analysis & Machine Learning** | **Python Developer**

I build **real-world ML projects** using Python, Scikit-learn, and Streamlit to solve practical problems across healthcare, governance, and technology domains.  
My focus is on creating **end-to-end applications** that go from raw data to deployed web apps.
